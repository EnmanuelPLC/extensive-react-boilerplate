...
import { useCreateCampaignService } from "@/services/api/services/campaigns";
...
const useValidationSchema = () => {
  ...
  const { t } = useTranslation("admin-panel-campaigns-create");
...
function FormCreate() {
  ...
  const fetchCreateCampaign = useCreateCampaignService();
  const { t } = useTranslation("admin-panel-campaigns-create");
  ...
  const onSubmit = handleSubmit(
    async (
      ...
      const { data, status } = await fetchCreateCampaign({
